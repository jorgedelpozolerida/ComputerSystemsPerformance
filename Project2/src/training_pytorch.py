...
def main(args):
    file_name  = f"run-${args.run}_device-${args.device}_epoch-${args.epochs}_batchsize-${args.batch_size}_framework-pytorch_dataset-${args.dataset}_model-${args.model}_MODEL.csv"
